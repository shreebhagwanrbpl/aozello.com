      ...
      <section className="section-padding bg-white">
        ...
        <div className="max-w-2xl mx-auto mt-6 lg:mt-10 px-4 lg:px-0 relative">
          ...
          <input
            ...
            className="w-full h-16 pl-14 pr-5 rounded-2xl border border-red-100 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-red-200
...
"
            ...
            <div className="space-y-3">
              {Object.keys(sortedGroupedProducts)
                ...
                .map((category) => (
                  <div
                    key={category}
                    className="border rounded-2xl overflow-hidden border-red-100"
                  >
                    <button
                      onClick={() =>
                    ...
                    >
                      ...
                      {groupedProducts[
                        ...
                        <button
                          ...
                          className="block w-full text-left px-6 py-3 border-t border-slate-100 hover:bg-red-50"
                        >
          ...
          <div className="space-y-16">
            {filteredProducts.length === 0 ? (
              ...
              <div className="bg-white border border-red-100 rounded-[32px] p-10 lg:p-16 text-center shadow-lg">

                <div className="w-24 h-24 mx-auto rounded-full bg-red-100 text-red-600 flex items-center justify-center text-5xl mb-6">
                  🔍
                </div>
                ...
                <button
                  ...
                  className="mt-8 px-8 py-3 rounded-xl bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-700 hover:to-orange-600 text-white font-semibold shadow-lg hover:shadow-red-300/40 transition-all duration-300"                >
                  View All Products
                </button>
              ...
              Object.entries(groupedProducts).map(
                ([category, list]) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-b border-red-100 pb-4 lg:pb-5 mb-6 lg:mb-8">
                    ...
                    <div className="space-y-8">
                      ...
                      {list.map((product) => (
                        ...
                        <div
                          key={product.uid}
                          id={product.slug}
                          className="bg-white rounded-[30px] border border-red-100 shadow-lg hover:shadow-2xl transition-all duration-300 p-8"
                        >
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr_180px] gap-5 lg:gap-8 items-center">
                            ...
                            <div className="relative h-[180px] sm:h-[220px] rounded-2xl lg:rounded-3xl overflow-hidden bg-red-50">
                            ...
                            <div className="flex justify-center lg:justify-end">
                              ...
                              <Link
                                ...
                                className="px-8 py-4 rounded-2xl bg-gradient-to-r from-red-600 to-orange-500 text-white"
                              >
                                Get Quote
                              </Link>
      ...
      {/* Why Choose Products */}
      <section className="section-padding bg-red-50 border border-red-100">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mt-16">
            ...
            {[
              ...
              >
                ...
                <div className="w-16 h-16 mx-auto rounded-[22px] bg-red-100 text-red-600 text-red-600 flex items-center justify-center mb-6">
      ...
      {showTopButton && (
        ...
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-50 w-14 h-14 rounded-full bg-gradient-to-r from-red-600 to-orange-500 text-white shadow-2xl hover:scale-110 transition flex items-center justify-center"
        >
