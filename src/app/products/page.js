      ...
      <section className="py-24 bg-red-50">
        ...
        <div className="max-w-7xl mx-auto px-5">
          ...
          ====================== */}
            ...
            <aside className="sticky top-28 h-fit bg-white rounded-3xl border border-red-100 shadow-xl p-6">
              ...
              <input
                ...
                className="w-full h-12 mt-5 rounded-xl border border-slate-300 px-4 outline-none focus:border-red-600 focus:ring-2 focus:ring-red-200"
              />
                    ...
                    >
                      ...
                      {groupedProducts[
                        ...
                        <button
                          ...
                          className="block w-full text-left px-6 py-3 border-t border-slate-100 hover:bg-red-50 text-sm"
                        >
                      ...
                      <div className="space-y-6">
                        ...
                        {list.map((product) => (
                          ...
                          <div
                            key={product.slug}
                            id={product.slug}
                            className="bg-white rounded-[28px] border border-red-100 shadow-lg p-7 hover:shadow-2xl hover:border-red-300 transition duration-300"
                          >
                            ...
                            <div className="grid lg:grid-cols-[250px_1fr_180px] gap-8 items-center">
                              ...
                              <div className="bg-red-50 rounded-2xl h-[220px] flex items-center justify-center overflow-hidden">
                              ...
                              <div className="flex justify-center lg:justify-end">
                                ...
                                >
                                  ...
                                  <button className="bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-700 hover:to-orange-600 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 w-full shadow-lg hover:shadow-red-300/40">
        ...
        <div className="max-w-7xl mx-auto px-5">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mt-16">
            ...
            {[
              ...
              <div
                key={index}
                className="bg-red-50 rounded-[30px] p-8 border border-red-100 text-center hover:shadow-xl transition-all duration-300"
              >

                <div className="w-20 h-20 mx-auto rounded-3xl bg-red-100 flex items-center justify-center text-red-600 mb-6">
