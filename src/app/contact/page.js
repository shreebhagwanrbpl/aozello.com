      ...
      <section className="section-padding bg-white">
        <div className="container-custom grid lg:grid-cols-2 gap-14">
          ...
          <div>
            ...
            <span className="inline-block bg-orange-100 text-red-700 px-5 py-2 rounded-full font-semibold mb-5">
              Contact Information
            </span>
            ...
            <div className="space-y-6 mt-10">
              ...
              <div className="flex items-start gap-5 bg-slate-50 p-6 rounded-[28px] border border-slate-100">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-r from-red-600 to-orange-500 flex items-center justify-center text-white shadow-lg shadow-red-300/40">
                  <Phone size={24} />
                </div>
          ...
          <div className="bg-white rounded-[40px] p-8 lg:p-10 shadow-[0_20px_60px_rgba(0,0,0,0.08)]">
            ...
            >
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full bg-red-700 text-white py-4 rounded-2xl font-semibold hover:bg-orange-800 transition"
              >
                {submitting
                  ? "Submitting..."
                  : "Send Message"}
