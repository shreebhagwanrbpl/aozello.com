...
export async function fetchHomeData() {
  return fetchDocCached("websites/aozellocom/pages/home");
}

export async function fetchContactData() {
  return fetchDocCached("websites/aozellocom/pages/contact");
}

export async function fetchServicesData() {
  return fetchDocCached("websites/aozellocom/pages/services");
}

export async function fetchDistrictData(district) {
  if (!district) return null;
  return fetchDocCached(`websites/aozellocom/districts/${district}`);
}
